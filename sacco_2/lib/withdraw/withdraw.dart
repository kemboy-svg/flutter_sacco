  ...
  depositMoney(double amount) {
    ...
    return FirebaseFirestore.instance
        .runTransaction((transaction) async {
          ...
          double accBalance = snapshot['Balance'];
          double newBalance;
          ...
          if (amount >= accBalance) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text('You dnont have enougn amount to withdraw $numAmount your balance is ${accBalance.toStringAsFixed(1)}'),
        ...
        .then((value) => print("Member account updated to $value"))
        .catchError(
          (error) => print("Failed to update user account: $error"),
        );
  }
...
//Draw the image to the PDF page.
  ...
  document.form.fields.add(PdfTextBoxField(
    page,
    'Deposit',
    const Rect.fromLTWH(0, 240, 100, 20),
    text: 'New Balance: ',
    borderColor: PdfColor(255, 255, 255),
    font: PdfStandardFont(PdfFontFamily.timesRoman, 14),
  ));
